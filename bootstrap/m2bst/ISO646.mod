...
IMPLEMENTATION MODULE ISO646;


(* Operations *)

PROCEDURE isControl ( ch : CHAR ) : BOOLEAN; (* PURE *)
...
PROCEDURE isDigit ( ch : CHAR ) : BOOLEAN; (* PURE *)
...
PROCEDURE isUpper ( ch : CHAR ) : BOOLEAN; (* PURE *)
...
PROCEDURE isLower ( ch : CHAR ) : BOOLEAN; (* PURE *)
