...
_add_production( _compilation_unit,
                0x00200420, 0x40000000, 0x00000000,   // FIRST set
                0x00000000, 0x00000000, 0x00008000 )  // FOLLOW set

// #2
_add_production( _prototype,
                0x00000000, 0x40000000, 0x00000000,   // FIRST set
                0x00000000, 0x00000000, 0x00008000 )  // FOLLOW set

// #3
_add_production( _program_module,
                0x00000020, 0x00000000, 0x00000000,   // FIRST set
                0x00000000, 0x00000000, 0x00008000 )  // FOLLOW set
...
_add_production( _required_binding,
                0x00000000, 0x80000000, 0x00000000,   // FIRST set
                0x00408000, 0x80000000, 0x00000000 )  // FOLLOW set

// #7
_add_production( _bindable_operator,
                0x00082140, 0x0000644A, 0xC01C0000,   // FIRST set
                0x00000000, 0x00000000, 0x00800000 )  // FOLLOW set

// #8
_add_production( _import_list,
                0x00001200, 0x00000000, 0x00000000,   // FIRST set
                0x04408000, 0x80A00000, 0x00000000 )  // FOLLOW set

// #9
_add_production( _block,
                0x04400000, 0x80A00000, 0x00000000,   // FIRST set
                0x00000000, 0x00040000, 0x00000000 )  // FOLLOW set

// #10
_add_production( _declaration,
                0x00400000, 0x80A00000, 0x00000000,   // FIRST set
                0x04008000, 0x00000000, 0x00000000 )  // FOLLOW set

// #11
_add_production( _definition,
                0x00400000, 0x80A00000, 0x00000000,   // FIRST set
                0x00008000, 0x00000000, 0x00000000 )  // FOLLOW set

// #12
_add_production( _const_declaration,
                0x00000000, 0x00040000, 0x00000000,   // FIRST set
                0x00000000, 0x00000004, 0x00000000 )  // FOLLOW set

// #13
_add_production( _type,
                0x58000001, 0xA4040000, 0x05000000,   // FIRST set
                0x00000000, 0x00000004, 0x00000000 )  // FOLLOW set

// #14
_add_production( _range,
                0x00000000, 0x00000000, 0x01000000,   // FIRST set
                0x00000008, 0x00000000, 0x00000000 )  // FOLLOW set

// #15
_add_production( _enumeration_type,
                0x00000000, 0x00000000, 0x04000000,   // FIRST set
                0x00000000, 0x00000004, 0x00000000 )  // FOLLOW set

// #16
_add_production( _array_type,
                0x18000000, 0x00000000, 0x00000000,   // FIRST set
                0x00000000, 0x00000004, 0x00000000 )  // FOLLOW set

// #17
_add_production( _record_type,
                0x00000000, 0x20000000, 0x00000000,   // FIRST set
                0x00000000, 0x00000004, 0x00000000 )  // FOLLOW set
...
_add_production( _field_list,
                0x00000000, 0x00040000, 0x00000000,   // FIRST set
                0x00008000, 0x00000004, 0x00000000 )  // FOLLOW set

// #20
_add_production( _set_type,
                0x00000000, 0x04000000, 0x00000000,   // FIRST set
                0x00000000, 0x00000004, 0x00000000 )  // FOLLOW set

// #21
_add_production( _pointer_type,
                0x00000001, 0x00000000, 0x00000000,   // FIRST set
                0x00000000, 0x00000004, 0x00000000 )  // FOLLOW set
...
_add_production( _formal_type_list,
                0x10C00000, 0x00340000, 0x00000000,   // FIRST set
                0x00000000, 0x00000024, 0x00000000 )  // FOLLOW set

// #24
_add_production( _formal_type,
                0x10C00000, 0x00340000, 0x00000000,   // FIRST set
                0x00000000, 0x00000824, 0x00000000 )  // FOLLOW set

// #25
_add_production( _attributed_formal_type,
                0x10C00000, 0x00240000, 0x00000000,   // FIRST set
                0x00000000, 0x00000824, 0x00000000 )  // FOLLOW set

// #26
_add_production( _simple_formal_type,
                0x10800000, 0x00040000, 0x00000000,   // FIRST set
                0x00000000, 0x00000824, 0x00000000 )  // FOLLOW set

// #27
_add_production( _variadic_formal_type,
                0x00000000, 0x00100000, 0x00000000,   // FIRST set
                0x00000000, 0x00000824, 0x00000000 )  // FOLLOW set
...
_add_production( _formal_param_list,
                0x00400000, 0x00340000, 0x00000000,   // FIRST set
                0x00000000, 0x00000000, 0x02000000 )  // FOLLOW set

// #32
_add_production( _formal_params,
                0x00400000, 0x00340000, 0x00000000,   // FIRST set
                0x00000000, 0x00100004, 0x02000000 )  // FOLLOW set
...
_add_production( _variadic_formal_params,
                0x00400000, 0x00240000, 0x00000000,   // FIRST set
                0x00000000, 0x00100004, 0x02000000 )  // FOLLOW set

// #35
_add_production( _statement,
                0x01006880, 0x180C0000, 0x00000000,   // FIRST set
                0x00028000, 0x00400004, 0x08000000 )  // FOLLOW set

// #36
_add_production( _statement_sequence,
                0x01006880, 0x180C0000, 0x00000000,   // FIRST set
                0x00038000, 0x00400000, 0x08000000 )  // FOLLOW set
...
_add_production( _if_statement,
                0x00000800, 0x00000000, 0x00000000,   // FIRST set
                0x00028000, 0x00400004, 0x08000000 )  // FOLLOW set
...
_add_production( _case,
                0x00800010, 0x00072400, 0x04400000,   // FIRST set
                0x00028000, 0x00000000, 0x08000000 )  // FOLLOW set

// #41
_add_production( _case_labels,
                0x00800010, 0x00072400, 0x04400000,   // FIRST set
                0x00000000, 0x00000820, 0x00000000 )  // FOLLOW set

// #42
_add_production( _while_statement,
                0x00000000, 0x00080000, 0x00000000,   // FIRST set
                0x00028000, 0x00400004, 0x08000000 )  // FOLLOW set

// #43
_add_production( _repeat_statement,
                0x00000000, 0x10000000, 0x00000000,   // FIRST set
                0x00028000, 0x00400004, 0x08000000 )  // FOLLOW set
...
_add_production( _for_statement,
                0x00002000, 0x00000000, 0x00000000,   // FIRST set
                0x00028000, 0x00400004, 0x08000000 )  // FOLLOW set

// #46
_add_production( _const_expression,
                0x00800010, 0x00072400, 0x04400000,   // FIRST set
                0x02040008, 0x000008A4, 0x02E00000 )  // FOLLOW set

// #47
_add_production( _relation,
                0x00000100, 0x00008003, 0xE0000000,   // FIRST set
                0x00000010, 0x00072400, 0x04000000 )  // FOLLOW set

// #48
_add_production( _simple_const_expr,
                0x00800010, 0x00072400, 0x04400000,   // FIRST set
                0x00000100, 0x00008013, 0xE0000000 )  // FOLLOW set

// #49
_add_production( _add_operator,
                0x00000002, 0x00002400, 0x00000000,   // FIRST set
                0x00000010, 0x00070000, 0x04000000 )  // FOLLOW set

// #50
_add_production( _const_term,
                0x00800010, 0x00070000, 0x04400000,   // FIRST set
                0x00000102, 0x0000A413, 0xE0000000 )  // FOLLOW set

// #51
_add_production( _mul_operator,
                0x20080040, 0x00004040, 0x00000000,   // FIRST set
                0x00000010, 0x00070000, 0x04000000 )  // FOLLOW set

// #52
_add_production( _const_factor,
                0x00800010, 0x00070000, 0x04400000,   // FIRST set
                0x20080142, 0x0000E453, 0xE0000000 )  // FOLLOW set

// #53
_add_production( _designator,
                0x00000000, 0x00040000, 0x00000000,   // FIRST set
                0x00008000, 0x0000120C, 0x04000000 )  // FOLLOW set

// #54
_add_production( _designator_tail,
                0x00000000, 0x00000000, 0x11000000,   // FIRST set
                0x00008000, 0x0000120C, 0x04000000 )  // FOLLOW set

// #55
_add_production( _expression_list,
                0x00800010, 0x00072400, 0x04400000,   // FIRST set
                0x00000000, 0x00000000, 0x02800000 )  // FOLLOW set

// #56
_add_production( _expression,
                0x00800010, 0x00072400, 0x04400000,   // FIRST set
                0x00078008, 0x03400804, 0x0A800000 )  // FOLLOW set

// #57
_add_production( _simple_expression,
                0x00800010, 0x00072400, 0x04400000,   // FIRST set
                0x00078018, 0x03472C14, 0x0A800000 )  // FOLLOW set

// #58
_add_production( _term,
                0x00800010, 0x00070000, 0x04400000,   // FIRST set
                0x0007801A, 0x03472C14, 0x0A800000 )  // FOLLOW set
...
_add_production( _const_structured_value,
                0x00000000, 0x00000000, 0x00400000,   // FIRST set
                0x00028000, 0x00400804, 0x08200000 )  // FOLLOW set

// #63
_add_production( _const_value_component,
                0x00800010, 0x00072400, 0x04400000,   // FIRST set
                0x00000000, 0x00000800, 0x00200000 )  // FOLLOW set
...
_add_production( _qualident,
                0x00000000, 0x00040000, 0x00000000,   // FIRST set
                0x200F814A, 0x0340FE5F, 0xFF800000 )  // FOLLOW set

// #67
_add_production( _ident_list,
                0x00000000, 0x00040000, 0x00000000,   // FIRST set
                0x00008000, 0x00000024, 0x02000000 )  // FOLLOW set
